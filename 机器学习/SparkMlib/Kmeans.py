...
if __name__ == "__main__":
    path = "/home/hadoop/data_school/sparkMlib/iris.txt"
    ...
    iris_DF = sc.textFile(path).map(lambda line: line.split(',')).map(
        lambda p: Row(**f(p))).toDF()  # transform RDD to DataFrame
    iris_DF.show()
